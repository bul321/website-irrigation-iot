...
<head>
    ...
    <title>Reset Password Baru - Smart Irrigation</title>
...
<body class="bg-[#F1F8E9] flex items-center justify-center min-h-screen font-sans">
    ...
    <div
        ...
        <h2 class="text-2xl font-black text-[#558B2F] text-center mb-1 drop-shadow-xs">Password Baru 🛠️</h2>
        <p class="text-xs font-semibold text-[#689F38] text-center mb-6">Silakan buat password baru yang aman dan
            gampang lo ingat.</p>
        ...
        <form method="POST" action="{{ route('password.update') }}" class="space-y-5">
            ...
            <div>
                <label class="block text-xs font-bold text-[#33691E] uppercase tracking-wider mb-1.5">
                    <i class="fa-solid fa-shield-halved mr-1"></i> Konfirmasi Password Baru
                </label>
